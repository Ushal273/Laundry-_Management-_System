    ...
    <div class="container-fluid">
        <div class="row mt-5">
            ...
            <div class="col-10 mt-3">
                <div class="shadow">
                    <p class="text-center font-weight-bold text-white p-2 bg-dark">ITEMS</p>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center ">
                                                <form action="edit.php" method="POST">
                                                    <input type="hidden" value="<?php echo $data['item_id']; ?>" name="item_id">
                ...
                <div class="float-right bg-danger mr-3 shadow-lg" style="margin-top: 2rem;">
                    <a href="./add-new-item.php" class="text-white p-2"><i class="fas fa-plus fa-3x"></i></a>
                </div>
